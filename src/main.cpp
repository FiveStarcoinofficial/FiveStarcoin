...
const string strMessageMagic = "Fivestarcoin Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Fivestarcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Fivestarcoin for fun and gain";
        CTransaction txNew;
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x3fb1f99d2ffa52ffb2486c5384b4ce9e1c1368177b0190d434217f398b4b667e"));
        block.print();
