...
#endif
void ThreadwDNSAddressSeed2(void* parg);
...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("Fivestarcoin-ext-ip");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("Fivestarcoin-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Fivestarcoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
{"199.188.204.183", "199.188.204.183"},
{"198.187.28.213", "198.187.28.213"},
{"162.213.254.114", "162.213.254.114"},
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("Fivestarcoin-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("Fivestarcoin-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("Fivestarcoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("Fivestarcoin-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Fivestarcoin is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("Fivestarcoin-start");
